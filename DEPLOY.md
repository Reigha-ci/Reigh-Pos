# Panduan Deployment ReighPOS

Panduan ini berisi langkah-langkah untuk mendeploy ReighPOS ke server produksi (VPS Ubuntu/Debian).
...
```bash
cd /var/www
git clone https://github.com/username/ReighPOS.git
cd ReighPOS
```

...
use App\Livewire\Admin\Kitchen;
...
use App\Livewire\Admin\CateringManager;
use App\Livewire\Front\OrderIndex;
use App\Livewire\Front\OrderPage;
use App\Livewire\Front\Kiosk;
use App\Livewire\Front\CateringOrder;
use App\Livewire\Front\CateringInvoice;
...
Route::match(['get', 'post'], '/webhook/midtrans', [MidtransWebhookController::class, 'handle']);
...
// Fitur Pesanan Online & Katering (Public)
Route::get('/catering', CateringOrder::class)->name('catering.index');
Route::get('/catering/{slug}', CateringOrder::class)->name('catering.tenant');
Route::get('/catering/invoice/{orderId}', CateringInvoice::class)->name('catering.invoice');

// Customer Routes (Scan QR Meja & Kiosk)
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // Online & Catering Orders (Owner, Cashier, Kitchen)
        Route::middleware(['role:owner,cashier,kitchen'])->group(function () {
            Route::get('/catering', CateringManager::class)->name('catering');
        });

        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center">
            <div>
                ...
                <p class="text-slate-400 text-lg max-w-xl">
                    Selamat datang kembali di panel admin {{ auth()->user()->tenant->name ?? \App\Models\Setting::value('store_name', 'KedaiRobby.id') }}. Hari ini sepertinya waktu yang tepat untuk meningkatkan penjualan!
                </p>
            </div>

    ...
    <div class="flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white overflow-y-auto">
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="text-center lg:text-left">
                <div class="inline-flex items-center gap-3 mb-4 lg:mb-8">
                    @if($globalLogo)
                    ...
                    @else
                        <div class="w-10 h-10 rounded-xl bg-purple-600 flex items-center justify-center text-white shadow-lg shadow-purple-600/20 font-black text-lg">

    ...
    <div class="bg-white sticky top-0 z-40 shadow-sm/50 border-b border-slate-50">
        ...
        <div class="px-6 py-4 flex justify-between items-center bg-white">
            <div class="flex items-center gap-3">
                @if($storeLogo)
                    <img src="{{ asset('storage/' . $storeLogo) }}" alt="{{ $storeName }}" class="w-10 h-10 rounded-xl object-cover border border-slate-100 shadow-sm bg-white">
                @else
                ...
                <div>
                    ...
                    <h1 class="text-lg font-black text-slate-800 tracking-tight">{{ $storeName }}</h1>
                </div>
            </div>
